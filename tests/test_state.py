...
class TestState_changed:
    ...
    def test_not_changed_if_initial_state(self):
        """".changed 
        it should indicate that it is not_changed_if_initial_state
        ...
        """
        assert machine.initial_state.changed == None, "should indicate that it is not changed if initial state"

    def test_external_transitions_with_entry_actions_should_be_changed(self):
        """".changed 
        states from external transitions with entry actions should be changed
        ...
        assert changed_state.changed ,"states from external transitions with entry actions should be changed"
...
class TestState_transitions:
    ...
    def test_state_transitions(self):
        ...
        * 3 - should have condition in the transition'
        ...
        #     });
        assert len(self.initial_state.transitions) == 0, \
            '1 - should have no transitions for the initial state'
    ...
    def test_state_prototype_matches(self):
    ...
    def test_state_prototype_to_strings(self):
        ...
        * 3 - should keep reference to state instance after destructuring
        ...
        #     });
        twoState = machine.transition('one', 'TO_TWO')
        assert (
            'IMPLEMENTED'=='NOT YET'
        ), '1 - should return all state paths as strings'
